...
class OrderDomainServiceImpl() : OrderDomainService {
    ...
    override fun validateAndInitiateOrderMethod(
        ...
        return OrderCreatedEvent(order, ZonedDateTime.now(ZoneId.of(UTC)), orderCreatedEventDomainEventPublisher)
    ...
    override fun payOrder(
        ...
        return OrderPaidEvent(order, ZonedDateTime.now(ZoneId.of(UTC)), orderPaidEventDomainEventPublisher)
    }
